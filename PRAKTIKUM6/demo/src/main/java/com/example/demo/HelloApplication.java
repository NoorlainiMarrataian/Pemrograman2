...
public class HelloApplication extends Application {
    ...
    private final ObservableList<Mahasiswa> data = FXCollections.observableArrayList(
            ...
            new Mahasiswa(9, "1242004", "Luhan"),
            new Mahasiswa(9, "1240611", "Kris"),
            new Mahasiswa(6, "1242205", "Suho"),
            new Mahasiswa(7, "1240710", "Lay"),
            new Mahasiswa(8, "1240605", "Baekhyun"),
            new Mahasiswa(9, "1242109", "Chen"),
            new Mahasiswa(10, "1242709", "Chanyeol"),
            new Mahasiswa(10, "1241201", "Kyungsoo"),
            new Mahasiswa(9, "1240205", "Tao"),
            new Mahasiswa(9, "1241401", "Kai"),
            new Mahasiswa(9, "1241204", "Sehun")
    );
